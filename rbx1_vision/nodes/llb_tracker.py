...
class LlbTracker(LKTracker):
    def __init__(self, node_name):
        super(LlbTracker, self).__init__(node_name)
        ...
        self.min_keypoints = rospy.get_param("~min_keypoints", 10)
...
#                 if  self.track_box :
#                     print 'self.track_box is None'
#                 if self.is_rect_nonzero(self.track_box) :
#                     print 'self.is_rect_nonzero is None'
...
if __name__ == '__main__':
    try:
        node_name = "llb_tracker"
        LlbTracker(node_name)
        rospy.spin()
